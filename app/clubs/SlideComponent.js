...
import { FaAngleLeft, FaAngleRight, FaLinkedin } from "react-icons/fa";
import {
  FaFacebook,
  FaTwitter,
  FaInstagram,
          ...
          <SwiperSlide key={club.id}>
            ...
            >
              <div className="image-content m-auto">
                <div className="card-image rounded-full m-auto  transition-transform duration-500 ease-in-out transform group-hover:scale-75">
                  <Image
                    src={club.image}
                    alt={club.name}
                    width={250}
