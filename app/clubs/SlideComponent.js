...
import { FaFacebook, FaTwitter, FaInstagram, FaEnvelope, Fawebsite } from 'react-icons/fa';
...
const clubsData = [
  ...
  },
  {
    ...
    description: 'The Student affiliated chapter of The Indian Institute of Metals was passed through council Meeting No: 342/III/2019-20 on Saturday,22nd November 2020 held at Kaladham Conference Hall, Vidyanagar in presence of president, Dr. U Kamachi Mudali [2019-20 Council Year] and other council members as per Point 6b resolution.',
    instagram: 'https://instagram.com/club2',
    facebook: 'https://facebook.com/club2',
    website: 'https://website.com/club2',
  },
  {
    ...
    description: 'The Indian Society for Technical Education(ISTE) is the leading National Professional non-profit making Society for the Technical Education System in our country with the motto of Career Development of Teachers and Personality Development of Students and overall development of our Technical Education System operating in association with All India Council for Technical Education (AICTE) and other International Projects.At present,ISTE has a very large and an effective membership base consisting of more than 1,02,985 Life Members,5,54,094 Student Members,2410 Institutional Members from IITs,NITs,IISc etc and 1322 Students’ Chapters',
    instagram: 'https://instagram.com/club2',
    facebook: 'https://facebook.com/club2',
    website: 'https://website.com/club2',
  },
  ...
  },
  {
    ...
    description: 'Maths N Tech Club is the official knowledge club of NIT Durgapur. MNTC holds several events and workshops based on Mathematics and latest Technologies. It publishes the Annual Technical Magazine, Anveshan. It conducts Aavishkar - The Tech Festival along with SAE and GLUG and ANK - The Maths Week',
    instagram: 'https://instagram.com/club2',
    facebook: 'https://facebook.com/club2',
    website: 'https://website.com/club2',
  },
  {
    ...
    name: 'Music Club',
    description: 'We are the official Music Club of NIT Durgapur. We bring the love we have for music to everyone in this college through live performances and the people outside the college through our page and YouTube channel. We perform both Eastern and Western genres of music',
    instagram: 'https://instagram.com/club2',
    facebook: 'https://facebook.com/club2',
    website: 'https://website.com/club2',
  },
  ...
  },
  {
    ...
    name: 'QuizInc',
    description: 'QuizInc is the official Knowledge club of the college, which dabbles in quizzing as well as the sharing of worldly information amongst all the students. From hidden facts of India to obscure sports trivia, from the intricacies of going viral to the joys of mainstream entertainment, from the controversies in the newspapers to the advancements in business and technology, QuizInc covers all dimensions of this unique world and filters it down for the common masses. They preach and practise the slogan "Cogita, Ergo Sum", (I think, therefore, I am), and strive to change the broad consciousness of this reputed college.',
    instagram: 'https://instagram.com/club2',
    facebook: 'https://facebook.com/club2',
    website: 'https://website.com/club2',
  },
  ...
  },
  {
    ...
    description: 'SAE India, the collegiate club of NIT Durgapur, established in 2007, aims to integrate the students of the college into the international fabric of automobile engineering. SAE organizes a plethora of innovative events, workshops, industrial visits, and lectures all around the year and provides a competitive space where the sharpest minds battle in a quest to achieve distinction',
    instagram: 'https://instagram.com/club2',
    facebook: 'https://facebook.com/club2',
    website: 'https://website.com/club2',
  },
        ...
        {clubsData.map((club) => (
          <SwiperSlide key={club.id}>
            ...
            >
              ...
              <div className="card-content text-center px-2 mb-2">
              ...
              <div className="absolute inset-x-0  bottom-0 transform translate-y-full transition-transform duration-300 ease-in-out group-hover:-translate-y-1  text-center p-2">
                ...
                <Link href={club.website} target="_blank" rel="noopener noreferrer" className="hover:text-primary text-white mx-3">
