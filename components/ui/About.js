    ...
    <Fade>
      <div className=" p-5 mt-10 bg-gray-100 border border-gray-300 rounded-lg shadow-md lg:mr-5 sm:mr-0">
        ...
        <p className="text-lg text-gray-800 mb-6">
          Students&appos; Gymkhana (SG) aims to provide students a role in the administrative and academic governance of the institute and supports them to develop leadership and administrative skills. We operate in a dynamic manner under the guidance of our faculty advisers.
        </p>
        <a
