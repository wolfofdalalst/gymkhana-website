        ...
        <div className="flex flex-col md:flex-row justify-between items-center md:items-start ">
          ...
          <div className="flex-col items-center mb-2 sm:mb-0 md:w-1/4">
            <div className=" hidden sm:flex mb-3 justify-center">
              <Image
                src="/Gymkhana Logo Final White (1).png"
                alt="Logo"
                width={100}
                height={100}
              />
            ...
            <div className="flex mt-2 w-2/6  justify-around mx-auto">
              <Link
                ...
                target="_blank"
                className="hover:text-primary hover:scale-105 active:text-blue-800 active:scale-100 transition-all duration-300"
              >
                <FaFacebook className=" h-5 w-5" />
              </Link>
              <Link
                href="https://www.linkedin.com/company/students-gymkhana-nit-durgapur/"
                target="_blank"
                className="hover:text-primary hover:scale-105 active:text-blue-800 active:scale-100 transition-all duration-300"
              >
          ...
          <div className="h-56 hidden md:block border-l border-dashed border-gray-400 mx-5">
            {" "}
          </div>
          ...
          <div className=" w-full md:w-3/4  flex flex-col md:flex-row  items-center md:items-start md:justify-between ">
            <div className="flex  justify-around md:justify-center w-full md:w-2/3 md:flex-row md:space-x-12 mb-2 md:mb-0   ">
              ...
              <div className=" m-1 md:mb-0 md:w-1/3 p-4  ">
                <h4 className="font-bold text-md md:text-2xl text-center md:text-left lg:whitespace-nowrap">
                  Quick Links
                </h4>
              ...
              <div className="md:w-1/3  m-1 p-4  ">
                ...
                <div className="grid grid-cols-1 gap-1 mt-4 text-sm md:text-lg ">
                  ...
                  <Link
                    href="https://placement.nitdgp.ac.in/"
                    target="_blank"
                    className="hover:text-primary transition-all duration-300"
                  >
                    Placement Portal
            ...
            <div className="md:w-1/3 md:ml-10 p-4 mt-1  flex-col justify-center items-center  ">
              <h4 className="font-bold text-lg md:text-2xl text-center md:text-left">
                Contact Us
              </h4>
